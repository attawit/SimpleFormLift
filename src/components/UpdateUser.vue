  ...
  <div class="w-5/6 md:w-3/4 lg:w-2/3 mx-auto mt-8" v-if="activeUser">
    ...
    <div class="flex mt-8 pt-8 border-t border-grey-light">
      ...
      <form
        ...
        :key="key"
      >
        <label for="name" class="text-grey-darker font-light inline-block mb-2"
          >Name</label
        >
        <input
          class="
        ...
        />
        <label for="role" class="text-grey-darker font-light inline-block mb-2"
          >Title</label
        >
        <input
          class="
          ...
          @input="updateLocalUser($event)"
        />
        <label for="email" class="text-grey-darker font-light inline-block mb-2"
          >Email</label
        >
        <input
          class="
          ...
          @input="updateLocalUser($event)"
        />
        <label for="insta" class="text-grey-darker font-light inline-block mb-2"
          >Instagram</label
        >
        <input
          class="
